...
class FarmersControllerTest < ActionController::TestCase
  ...
  test "should create farmer" do
    assert_difference('Farmer.count') do
      post :create, farmer: { location: @farmer.location, name: @farmer.name, phone_number: @farmer.phone_number, registration_number: @farmer.registration_number }
    end
  ...
  test "should update farmer" do
    patch :update, id: @farmer, farmer: { location: @farmer.location, name: @farmer.name, phone_number: @farmer.phone_number, registration_number: @farmer.registration_number }
    assert_redirected_to farmer_path(assigns(:farmer))
  end
